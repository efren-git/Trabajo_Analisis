...
La mediana de 87.8 en días con incendios indica que más del 50% de estos eventos
 ocurren cuando el FFMC supera este valor, mientras que en días sin incendios
 la mediana es de apenas 68.25.
...
ggplot(tabla, aes(x = Region, y = DC, fill = Classes)) +
  ...
  theme_minimal()
```
En AMBAS regiones, los días con incendios tienen
valores de DC mucho más altos que los dias sin  incendios
...
```
 como podemos ver :
 cuando hay inciendios el DC mas alto seria 70.81 que es mas alto cuando no hay incendios
