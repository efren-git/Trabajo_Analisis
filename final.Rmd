...
Como en todos los casos la asimetría \> 0, la mediana es un
...
que la curtosis siempre es negativa por lo que los datos son platicúrticos.
...
Con los datos, podemos afirmar que los datos son asimétricos a la derecha por ser la asimetría positiva, por lo que el mejor representante de los datos es la mediana.
